...
function o(h2, i2) {
  ...
  return { format: u2, quality: r(null != o2 ? o2 : d2, 0, 100), area: l2, width: g2, height: f2, rotation: n2, disableDecorations: !!a2, ignoreBackground: !!(h2 == null ? void 0 : h2.ignoreBackground), ignorePadding: !!(h2 == null ? void 0 : h2.ignorePadding) };
}
function n(t, h2) {
  const i2 = o(t, h2), e2 = i2.area, n2 = i2.width / e2.width, a2 = b(i2, h2.padding), r3 = a2.left + a2.right, l2 = a2.top + a2.bottom, g2 = h2.width - r3, f2 = h2.height - l2, u2 = Math.floor(g2 * n2 + r3), d2 = Math.floor(f2 * n2 + l2), c2 = (t == null ? void 0 : t.layers) ?? [], s3 = i2.ignoreBackground, w2 = i2.ignorePadding;
...
//# sourceMappingURL=chunk-5RIBAS2R.js.map
