...
function L(t, r3) {
  ...
  for (let e5 = o2.length - 1; e5 >= 0; --e5) {
    ...
    if ("preprocessor" === t2.type) {
      ...
      if ((r4 == null ? void 0 : r4[1]) && T.has(r4[1].trim())) {
        const t3 = o2[e5 + 1];
        o2.splice(e5, t3 && "whitespace" === t3.type ? 2 : 1);
      }
      const a5 = t2.data.match(/#ifdef\s+(.*)/);
      (a5 == null ? void 0 : a5[1]) && T.has(a5[1].trim()) && (t2.data = "#if 1");
      const n4 = t2.data.match(/#ifndef\s+(.*)/);
      (n4 == null ? void 0 : n4[1]) && T.has(n4[1].trim()) && (t2.data = "#if 0");
    }
  }
  return X(t, b(o2));
}
...
var _2 = a() ? (t, e5) => {
  if (t == null ? void 0 : t.supportsNaN) return;
  const o2 = e5.length;
...
//# sourceMappingURL=chunk-WSW5LOWY.js.map
