...
// node_modules/@arcgis/core/rest/networks/unitIdentifiers/insertGap.js
async function e(e2, n, p2) {
  const f2 = f(e2), m = { ...n.toJSON(), f: "json" }, u2 = u({ ...f2.query, ...m }), a = s(u2, { ...p2, method: "post" }), d = `${f2.path}/unitIdentifiers/insertGap`, { data: j } = await H(d, a);
  return p.fromJSON(j);
}
export {
  e as insertGap
};
//# sourceMappingURL=insertGap-UMRD4ALG.js.map
