...
var _Handle = class _Handle extends LitElement {
  constructor() {
    super(...arguments);
...
_Handle.properties = { blurUnselectDisabled: [5, {}, { type: Boolean }], disabled: [7, {}, { reflect: true, type: Boolean }], dragHandle: [3, {}, { reflect: true }], label: 1, messageOverrides: [0, {}, { attribute: false }], selected: [7, {}, { reflect: true, type: Boolean }], setPosition: [9, {}, { type: Number }], setSize: [9, {}, { type: Number }] };
_Handle.styles = styles;
var Handle = _Handle;
...
@esri/calcite-components/dist/components/calcite-handle/customElement.js:
  ...
  v3.3.3 *)
*/
//# sourceMappingURL=customElement-KOVF4HZB.js.map
