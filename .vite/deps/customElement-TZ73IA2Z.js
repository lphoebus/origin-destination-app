...
async function getNormalizer(mode) {
  ...
  const { normalize } = await import("./time-zones-GKUS3FJM.js");
  return normalize;
}
async function createTimeZoneItems(locale, messages, mode, referenceDate, standardTime) {
  if (mode === "name") {
    const { groupByName } = await import("./groupByName-CLIHLNZU.js");
  ...
  if (mode === "region") {
    const [{ groupByRegion }, { getCountry, global: globalLabel }] = await Promise.all([
      import("./groupByRegion-K6Z5757O.js"),
      import("./region-EATMMQP4.js")
    ]);
  ...
  const [{ groupByOffset }, { DateEngine }] = await Promise.all([
    import("./groupByOffset-U2CAAET3.js"),
    import("./native-RQFNJP6Q.js")
  ]);
...
@esri/calcite-components/dist/components/calcite-input-time-zone/customElement.js:
  ...
  v3.3.3 *)
*/
//# sourceMappingURL=customElement-TZ73IA2Z.js.map
