...
var _DatePickerMonthHeader = class _DatePickerMonthHeader extends LitElement {
  ...
  async handlePenultimateValidMonth(event) {
    ...
    if (isTargetLastValidMonth) {
      if (!this.position) {
        ...
        (_a = this.yearInputRef.value) == null ? void 0 : _a.focus();
      }
    }
  }
  getPx(value) {
  ...
  renderYearInput() {
    var _a;
    const suffix = (_a = this.localeData.year) == null ? void 0 : _a.suffix;
...
_DatePickerMonthHeader.styles = styles;
...
@esri/calcite-components/dist/components/calcite-date-picker-month-header/customElement.js:
  ...
  v3.3.3 *)
*/
//# sourceMappingURL=customElement-VJ7YFMDN.js.map
