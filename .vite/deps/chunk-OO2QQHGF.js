...
function r2(r3) {
  r3.include(a2), r3.uniforms.add(new e3("geometryDepthTexture", (e6) => {
    var _a;
    return (_a = e6.geometryDepth) == null ? void 0 : _a.attachment;
  })), r3.code.add(t`bool geometryDepthTest(vec2 pos, float elementDepth) {
...
//# sourceMappingURL=chunk-OO2QQHGF.js.map
