...
function u(t2, e2, s) {
  var _a, _b, _c, _d;
  if (!((_a = t2[0]) == null ? void 0 : _a.effects) || !((_b = e2[0]) == null ? void 0 : _b.effects)) return true;
  return !((((_c = t2[0]) == null ? void 0 : _c.scale) === l || ((_d = e2[0]) == null ? void 0 : _d.scale) === l) && (t2.length > 1 || e2.length > 1) && s <= 0) && t(t2[0].effects, e2[0].effects);
}
function _(t2, e2, s) {
  const r = t2.length > e2.length ? t2 : e2, i2 = t2.length > e2.length ? e2 : t2, n = i2[i2.length - 1], c = (n == null ? void 0 : n.scale) ?? s, o = (n == null ? void 0 : n.effects) ?? [];
...
//# sourceMappingURL=chunk-7UQGNZ42.js.map
