...
function getLocaleHourFormat(locale) {
  ...
  return ((_a = parts.find(({ type }) => type === "dayPeriod")) == null ? void 0 : _a.value) ? "12" : "24";
}
function getLocalizedMeridiem({
  ...
  if (fromParts) {
    localizedMeridiem = ((_a = fromParts.find(({ type }) => type === "dayPeriod")) == null ? void 0 : _a.value) || null;
    ...
    if (localesWithBrowserBugs.includes(locale)) {
      ...
      localizedMeridiem = ((_b = parts.find(({ type }) => type === "dayPeriod")) == null ? void 0 : _b.value) || null;
    }
  }
...
function getLocalizedTimePart(part, parts, locale = "en") {
  ...
  if (part === "secondSuffix") {
    ...
    return (secondSuffixPart == null ? void 0 : secondSuffixPart.type) === "literal" && ((_c = secondSuffixPart.value) == null ? void 0 : _c.trim()) || null;
  }
  if (part === "meridiem") {
    const meridiemFromBrowser = ((_d = parts.find(({ type }) => type === "dayPeriod")) == null ? void 0 : _d.value) || null;
    if (meridiemFromBrowser) {
      return getLocalizedMeridiem({ locale, parts });
    }
  }
  return ((_e = parts.find(({ type }) => type === part)) == null ? void 0 : _e.value) || null;
}
...
function toISOTimeString(value, step = 60) {
  ...
  if (typeof value === "string") {
    ...
    [second, fractionalSecond] = (secondDecimal == null ? void 0 : secondDecimal.split(".")) || ["0"];
  } else {
    hour = value.hour;
    minute = value.minute;
    second = value.second;
...
var TimeController = class extends GenericController {
  ...
  hostUpdate(changes) {
    ...
    if (changes.has("messages") && ((_a = changes.get("messages")) == null ? void 0 : _a._lang) !== this.component.messages._lang) {
      updateHourFormat = true;
...
@esri/calcite-components/dist/chunks/useTime.js:
  (*! All material copyright ESRI, All Rights Reserved, unless otherwise specified.
  See https://github.com/Esri/calcite-design-system/blob/dev/LICENSE.md for details.
  v3.3.3 *)
*/
//# sourceMappingURL=chunk-UQDB2TUB.js.map
