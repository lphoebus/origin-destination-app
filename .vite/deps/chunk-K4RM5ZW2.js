...
var _TableRow = class _TableRow extends LitElement {
  ...
  updateCells() {
    ...
    const slottedCells = (_b = (_a = this.tableRowSlotEl.value) == null ? void 0 : _a.assignedElements({ flatten: true })) == null ? void 0 : _b.filter((el) => el.matches("calcite-table-cell") || el.matches("calcite-table-header"));
...
@esri/calcite-components/dist/components/calcite-table-row/customElement.js:
  ...
  v3.3.3 *)
*/
//# sourceMappingURL=chunk-K4RM5ZW2.js.map
