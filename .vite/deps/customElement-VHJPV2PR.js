...
var _CardGroup = class _CardGroup extends LitElement {
  constructor() {
    super();
    this.items = [];
  ...
  updateSlottedItems(target) {
    this.items = (target == null ? void 0 : target.assignedElements({ flatten: true }).filter((el) => el == null ? void 0 : el.matches("calcite-card"))) || [];
  }
  updateSelectedItems() {
...
_CardGroup.properties = { disabled: [7, {}, { reflect: true, type: Boolean }], label: 1, selectedItems: [0, {}, { attribute: false }], selectionMode: [3, {}, { reflect: true }] };
_CardGroup.styles = styles;
var CardGroup = _CardGroup;
...
@esri/calcite-components/dist/components/calcite-card-group/customElement.js:
  ...
  v3.3.3 *)
*/
//# sourceMappingURL=customElement-VHJPV2PR.js.map
