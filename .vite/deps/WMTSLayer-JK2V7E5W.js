...
import {
  e
} from "./chunk-P2DFXVPO.js";
import {
  o as o3
} from "./chunk-C5VVNXRO.js";
import {
  o as o2
...
__decorate([m({ type: z, json: { read: { source: "fullExtent" } } })], n2.prototype, "fullExtent", void 0), __decorate([m({ type: String, json: { read: { source: "id" } } })], n2.prototype, "id", void 0), __decorate([m({ type: z2, json: { read: { source: "tileInfo" } } })], n2.prototype, "tileInfo", void 0), n2 = l4 = __decorate([a3("esri.layers.support.TileMatrixSet")], n2);
var p3 = n2;
...
__decorate([m({ json: { read: { source: "id" } } })], i.prototype, "id", void 0), __decorate([m({ json: { read: { source: "title" } } })], i.prototype, "title", void 0), __decorate([m({ json: { read: { source: "abstract" } } })], i.prototype, "description", void 0), __decorate([m({ json: { read: { source: "legendUrl" } } })], i.prototype, "legendUrl", void 0), __decorate([m({ json: { read: { source: "isDefault" } } })], i.prototype, "isDefault", void 0), __decorate([m({ json: { read: { source: "keywords" } } })], i.prototype, "keywords", void 0), i = s2 = __decorate([a3("esri.layers.support.WMTSStyle")], i);
var p4 = i;
...
var $ = F2 = class extends p(f2(t2(b(j(l2(b2)))))) {
  constructor(...e2) {
    ...
    }, U), a2(() => this.sublayers, "after-add", ({ item: e3 }) => {
