...
async function m6(e6, o4, n6) {
  const { source: i6 } = o4, { loadGLTFMesh: a9 } = await p(import("./loadGLTFMesh-BRYBFLD3.js"), n6), l5 = await p4(i6, n6);
  s2(n6);
...
var a8 = class extends f {
  constructor(e6) {
    super(e6), this.externalSources = new O(), this._explicitDisplaySource = null, this.georeferenced = false, this.addHandles(a2(() => this.externalSources, "after-remove", ({ item: e7 }) => {
...
__decorate([m2()], a8.prototype, "externalSources", void 0), __decorate([m2()], a8.prototype, "displaySource", null), __decorate([m2()], a8.prototype, "_implicitDisplaySource", null), __decorate([m2()], a8.prototype, "_explicitDisplaySource", void 0), __decorate([m2()], a8.prototype, "georeferenced", void 0), a8 = __decorate([a3("esri.geometry.support.meshUtils.Metadata")], a8);
...
var Y2 = Q3 = class extends l2(p2(m3(c))) {
  ...
  async toBinaryGLTF(e6) {
    const [{ toBinaryGLTF: t4 }] = await Promise.all([import("./gltfexport-BB5TKRYQ.js"), this.load(e6)]);
  ...
  static async createFromGLTF(e6, t4, r4) {
    ...
    const { loadGLTFMesh: o4 } = await p(import("./loadGLTFMesh-BRYBFLD3.js"), r4);
...
} })], Y2.prototype, "vertexAttributes", void 0), Y2 = Q3 = __decorate([a3("esri.geometry.Mesh")], Y2);
var $ = j();

export {
  Y2 as Y
};
//# sourceMappingURL=chunk-WWTHSN2T.js.map
