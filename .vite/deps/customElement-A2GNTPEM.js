...
var _Select = class _Select extends LitElement {
  ...
  willUpdate(changes) {
    ...
    if (changes.has("selectedOption")) {
      this.value = (_a = this.selectedOption) == null ? void 0 : _a.value;
    }
  }
  updated() {
  ...
  loaded() {
    ...
    const selected = (_a = this.selectEl) == null ? void 0 : _a.selectedOptions[0];
    this.selectFromNativeOption(selected);
    afterConnectDefaultValueSet(this, ((_b = this.selectedOption) == null ? void 0 : _b.value) ?? "");
  }
...
@esri/calcite-components/dist/components/calcite-select/customElement.js:
  (*! All material copyright ESRI, All Rights Reserved, unless otherwise specified.
  See https://github.com/Esri/calcite-design-system/blob/dev/LICENSE.md for details.
  v3.3.3 *)
*/
//# sourceMappingURL=customElement-A2GNTPEM.js.map
