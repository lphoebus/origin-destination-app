...
var _m = class _m {
  ...
  dispose() {
    ...
    e.forEach((e2, t2) => {
      var _a2;
      return (_a2 = this.detachColorTexture(t2)) == null ? void 0 : _a2.dispose();
    }), (_a = this.detachDepthStencilBuffer()) == null ? void 0 : _a.dispose(), (_b = this.detachDepthStencilTexture()) == null ? void 0 : _b.dispose(), r3.gl.deleteFramebuffer(t), this._glName = null, r3.bindFramebuffer(i3 === this ? null : i3), r3.instanceCounter.decrement(O.FramebufferObject, this);
  }
  get glName() {
    return this._glName;
  }
  ...
  get width() {
    ...
    return ((_a = e == null ? void 0 : e.descriptor) == null ? void 0 : _a.width) ?? 0;
  }
  get height() {
    var _a;
    const e = this._colorAttachments.get(D) ?? this._depthStencilTexture ?? this._depthStencilBuffer;
    return ((_a = e == null ? void 0 : e.descriptor) == null ? void 0 : _a.height) ?? 0;
  }
  get usedMemory() {
    var _a;
    return [...this._colorAttachments].reduce((e, [t, r3]) => e + r3.usedMemory, ((_a = this.depthStencil) == null ? void 0 : _a.usedMemory) ?? 0);
  }
  getColorTexture(e) {
  ...
  attachColorTexture(e, t = D) {
    ...
    this._validateTextureDescriptor(r3), (_a = this.detachColorTexture(t)) == null ? void 0 : _a.dispose(), this._initialized && (this._context.bindFramebuffer(this), this._framebufferTexture2D(e.glName, t)), this._colorAttachments.set(t, e);
  }
  ...
  _attachDepthStencilTexture(e) {
    ...
    34041 === r3 || 6402 === r3 ? 34041 !== r3 || i3 === N.UNSIGNED_INT_24_8 ? 6402 !== r3 || i3 === N.UNSIGNED_INT || i3 === N.UNSIGNED_SHORT ? (this._validateTextureDescriptor(t), this._disposeDepthStencilAttachments(), this._initialized && (this._context.bindFramebuffer(this), this._framebufferTexture2D(e.glName, A2(r3))), (_a = this._depthStencilTexture) == null ? void 0 : _a.dispose(), this._depthStencilTexture = e) : console.error("Depth texture must have data type of UNSIGNED_INT or UNSIGNED_SHORT!") : console.error("Depth/Stencil texture must have data type of UNSIGNED_INT_24_8!") : console.error("Depth/Stencil texture must have a pixel type of DEPTH_STENCIL!");
  }
  ...
  copyToTexture(e, t, r3, i3, s2, n2, h2) {
    ...
    3553 !== h2.descriptor.target && console.error("Texture target must be TEXTURE_2D!"), (null == (o3 == null ? void 0 : o3.width) || null == (o3 == null ? void 0 : o3.height) || e + r3 > this.width || t + i3 > this.height || s2 + r3 > o3.width || n2 + i3 > o3.height) && console.error("Bad dimensions, the current input values will attempt to read or copy out of bounds!");
  ...
  resize(e, t) {
    ...
    if (F(r3, this._context.parameters.maxTextureSize), this._colorAttachments.forEach((e2) => e2.resize(r3.width, r3.height)), (_a = this._depthStencilTexture) == null ? void 0 : _a.resize(r3.width, r3.height), this._initialized && (F(r3, this._context.parameters.maxRenderbufferSize), (_b = this._depthStencilBuffer) == null ? void 0 : _b.resize(r3.width, r3.height), a())) {
...
//# sourceMappingURL=chunk-C5OUOU2L.js.map
