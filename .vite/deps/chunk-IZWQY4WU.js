...
async function q(e2, t, r3) {
  const { applyEdits: n3 } = await import("./editingSupport-X3U56QIY.js"), o2 = await e2.load();
  let i2 = r3;
...
async function S(e2, t, r3) {
  const { uploadAssets: n3 } = await import("./editingSupport-X3U56QIY.js"), o2 = await e2.load();
...
function K(e2) {
  var _a2;
  return !(!D2(e2) || !((_a2 = e2.capabilities) == null ? void 0 : _a2.query.supportsCurrentUser));
}
function X(e2) {
...
//# sourceMappingURL=chunk-IZWQY4WU.js.map
