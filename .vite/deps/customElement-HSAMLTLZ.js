...
// node_modules/@esri/calcite-components/dist/components/calcite-stepper-item/customElement.js
var CSS = {
  container: "container",
...
var _StepperItem = class _StepperItem extends LitElement {
  ...
  handleItemClick(event) {
    if (this.disabled || isHidden(this.el) || this.layout === "horizontal" && event.composedPath().some((el) => {
      var _a;
  ...
  getItemPosition() {
    var _a;
    return Array.from((_a = this.parentStepperEl) == null ? void 0 : _a.querySelectorAll("calcite-stepper-item:not([hidden]):not([item-hidden])")).indexOf(this.el);
  }
  render() {
...
@esri/calcite-components/dist/components/calcite-stepper-item/customElement.js:
  (*! All material copyright ESRI, All Rights Reserved, unless otherwise specified.
  See https://github.com/Esri/calcite-design-system/blob/dev/LICENSE.md for details.
  v3.3.3 *)
*/
//# sourceMappingURL=customElement-HSAMLTLZ.js.map
