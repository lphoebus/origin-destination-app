import {
  h as h2
} from "./chunk-P7E3KOMF.js";
import {
  e as e2
} from "./chunk-2HANFXMO.js";
import {
  f as f4
} from "./chunk-7J5JUSIW.js";
import {
  V
} from "./chunk-OIM3TTLB.js";
import {
  c as c2
} from "./chunk-446VQE2X.js";
import {
  c as c3
} from "./chunk-BAIJD2TT.js";
import {
  F
} from "./chunk-F2XUFJ3P.js";
import {
  t as t4
...
import {
  c
} from "./chunk-C6V5G2NM.js";
import {
  a as a4
} from "./chunk-KTDXPSQC.js";
import {
  s as s6
} from "./chunk-EHZJ26XE.js";
import {
  p as p7
} from "./chunk-UPSFEVKD.js";
import {
  a as a5
...
function c5(e4, o7, s7) {
  ...
  for (const n8 of s7) {
    ...
    n8.label = (s8 == null ? void 0 : s8.alias) || o8.alias, n8.format = h(o8) && (s8 == null ? void 0 : s8.fieldFormat) ? D2(s8.fieldFormat, o8) : null, i4 = true, l9.delete(o8.name);
  }
...
var et = class extends V(f4(c(n7(F2(a4(p4(p7(l6(e2(t(f3(l5(b3(j2(l3(s5(o4(l(b5))))))))))))))))))) {
  constructor(...e4) {
    super(...e4), this.attributeTableTemplate = null, this.charts = null, this.copyright = null, this.displayField = null, this.dynamicDataSource = null, this.fields = null, this.fieldsIndex = null, this.formTemplate = null, this.fullExtent = null, this.geometryType = null, this.graphicOrigin = new a6(this), this.hasM = void 0, this.hasZ = void 0, this.infoFor3D = null, this.isTable = false, this.labelsVisible = true, this.labelingInfo = null, this.legendEnabled = true, this.objectIdField = null, this.operationalLayerType = "ArcGISFeatureLayer", this.outFields = null, this.path = null, this.popupEnabled = true, this.popupTemplate = null, this.resourceInfo = null, this.screenSizePerspectiveEnabled = true, this.spatialReference = f2.WGS84, this.subtypeCode = null, this.supportedSourceTypes = /* @__PURE__ */ new Set(["Feature Layer", "Oriented Imagery Layer", "Table", "Catalog Layer"]), this.templates = null, this.timeInfo = null, this.title = null, this.sublayerTitleMode = "item-title", this.type = "feature", this.typeIdField = null, this.types = null, this.visible = true, this._debouncedSaveOperations = L(async (e5, t5, r3) => {
      const { save: i4, saveAs: o7 } = await import("./featureLayerUtils-QTB66BL3.js");
      switch (e5) {
        case 0:
          return i4(this, t5);
        case 1:
  ...
  readTypes(e4, t5) {
    ...
    const r3 = t5.editFieldsInfo, i4 = r3 == null ? void 0 : r3.creatorField, o7 = r3 == null ? void 0 : r3.editorField;
    return e4 == null ? void 0 : e4.map((e5) => (e5 = c3.fromJSON(e5), this._fixTemplates(e5.templates, i4), this._fixTemplates(e5.templates, o7), e5));
  }
  readVisible(e4, t5) {
    var _a;
  ...
  async createGraphicsSource(e4) {
    ...
    const { default: t5 } = await p(import("./FeatureLayerSource-DQ2BCRA3.js"), e4);
  ...
  async queryPivot(e4, t5) {
    ...
    const o7 = await import("./PivotQuery-FANLLFRX.js"), a8 = await r3.queryPivot(o7.default.from(e4), t5);
  ...
  async queryTopFeatures(e4, t5) {
    ...
    const o7 = await import("./TopFeaturesQuery-KPGR5CBB.js"), a8 = await r3.queryTopFeatures(o7.default.from(e4), t5);
    if (a8 == null ? void 0 : a8.features) for (const s7 of a8.features) s7.layer = s7.sourceLayer = this;
    return a8;
  }
  async queryAttributeBins(e4, t5) {
    ...
    ae(e4, i4, ze);
    const o7 = await import("./AttributeBinsQuery-PRVTEQDP.js"), a8 = await r3.queryAttributeBins(o7.default.from(e4), t5);
  ...
  async queryTopObjectIds(e4, t5) {
    ...
    const o7 = await import("./TopFeaturesQuery-KPGR5CBB.js");
...
//# sourceMappingURL=chunk-422REYLF.js.map
