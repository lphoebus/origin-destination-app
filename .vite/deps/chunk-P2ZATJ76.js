...
function d(d2, r) {
  if (10 !== r.output) return d2.vertex.code.add(t`void forwardObjectAndLayerIdColor() {}`), void d2.fragment.code.add(t`void outputObjectAndLayerIdColor() {}`);
  const e = r.instanced;
...
//# sourceMappingURL=chunk-P2ZATJ76.js.map
