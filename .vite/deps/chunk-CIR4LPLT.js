...
function n(n2) {
  n2.vertex.uniforms.add(new r("renderTransparentlyOccludedHUD", (e3) => 0 === e3.hudRenderStyle ? 1 : 1 === e3.hudRenderStyle ? 0 : 0.75), new e2("viewport", (e3) => e3.camera.fullViewport), new e("hudVisibilityTexture", (e3) => {
    var _a;
    return (_a = e3.hudVisibility) == null ? void 0 : _a.getTexture();
  })), n2.vertex.include(l), n2.vertex.code.add(t`bool testHUDVisibility(vec4 posProj) {
...
//# sourceMappingURL=chunk-CIR4LPLT.js.map
