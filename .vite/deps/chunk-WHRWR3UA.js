...
var h = class {
  ...
  add(e, t, n2) {
    this._entries.has(e) ? r().warn(`Ignoring duplicate varying ${t} ${e}`) : this._entries.set(e, { type: t, invariant: (n2 == null ? void 0 : n2.invariant) ?? false });
  }
  generateSource(e) {
    const t = new Array();
...
var __ = class __ {
  ...
  add(e, t, n2 = 0) {
    ...
    (s3 == null ? void 0 : s3.name) !== e || (s3 == null ? void 0 : s3.type) !== t ? this._entries.set(n2, { name: e, type: t }) : r().warn(`Fragment shader output location ${n2} occupied`);
  }
  generateSource(e) {
    if ("vertex" === e) return [];
...
//# sourceMappingURL=chunk-WHRWR3UA.js.map
