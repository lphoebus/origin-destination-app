...
import {
  $
} from "./chunk-FLG2QLAZ.js";
import "./chunk-4N6G5MOZ.js";
...
import {
  p as p3,
  s as s7
} from "./chunk-FVRWNO5T.js";
import {
  i as i3
} from "./chunk-RP3E4PQR.js";
...
import {
  s as s8
} from "./chunk-EHZJ26XE.js";
import {
  A,
  l as l5
} from "./chunk-K3QAOA2T.js";
import {
  f as f2
} from "./chunk-SK3B5SIS.js";
import {
  c,
  u as u3
...
import {
  d as d3
} from "./chunk-WSMZUH7B.js";
import {
  o as o2,
  s as s5
} from "./chunk-ELAMNKWL.js";
import {
  s as s6
...
var a7 = (t6) => {
  ...
  let p6 = class extends a8 {
    ...
    async loadTimeInfoFromService(e3) {
      ...
      const c3 = new m5({ start: m8, end: a9 });
      this.setAtOrigin("timeInfo", new u3({ endField: i6, startField: r3, fullTimeExtent: c3 }), "service");
    }
  };
  return __decorate([m3({ type: u3, json: { read: false, write: false } })], p6.prototype, "timeInfo", null), __decorate([m3({ type: m5, json: { read: false, write: false } })], p6.prototype, "timeExtent", null), __decorate([m3({ type: c, json: { read: false, write: false } })], p6.prototype, "timeOffset", null), __decorate([m3({ type: Boolean, nonNullable: true, json: { read: false, write: false } })], p6.prototype, "datesInUnknownTimezone", null), __decorate([m3({ type: c2, readOnly: true, json: { read: { source: "timeInfo" } }, clonable: false })], p6.prototype, "serviceTimeInfo", void 0), p6 = __decorate([a3("esri.layers.mixins.TemporalSceneLayer")], p6), p6;
};
...
__decorate([m3({ type: String })], c2.prototype, "endTimeField", void 0), __decorate([m3({ type: String })], c2.prototype, "startTimeField", void 0), c2 = __decorate([a3("esri.layers.mixins.TemporalSceneLayer.SceneServiceTimeInfo")], c2);
...
var g2 = u4 = class extends n2 {
  ...
  initialize() {
    this.addHandles(a2(() => this.geometries, "after-changes", () => this.geometries = this.geometries, U));
  }
...
async function t5(e3) {
  const { BlobReader: t6, ZipReader: r3, BlobWriter: n8 } = await import("./zipjs-wrapper-YT4SHZGU.js"), a8 = [], i6 = new r3(new t6(e3));
...
var Pe = s8();
var Te = class extends a7(F(_2(l4(b(j2(t(l2(s6(o3(l(b3))))))))))) {
  constructor(...e3) {
  ...
  set renderer(e3) {
    y2(e3, this.fieldsIndex), this._set("renderer", e3);
  }
  ...
  readProfile(e3, t6) {
    ...
    return null != r3 && Ae[r3] ? Ae[r3] : (i2.getLogger(this).error("Unknown or missing profile", { profile: r3, layer: this }), "mesh-pyramids");
  }
  get useViewTime() {
    var _a;
  ...
  async _loadFilterGeometries() {
    if (this.filter) try {
      ...
      i2.getLogger(this).error("#_loadFilterGeometries()", this, "Failed to load filter geometries. Geometry filter will not be applied for this layer.", { error: e3 }), this.filter = null;
    }
  }
  createQuery() {
    const e3 = new b2();
  ...
  getFieldUsageInfo(e3) {
    ...
    return this.loaded ? this._fieldUsageInfo[e3] || t6 : (i2.getLogger(this).error("#getFieldUsageInfo()", "Unavailable until layer is loaded"), t6);
  }
  ...
  async applyEdits(e3, t6) {
    const { applyEdits: r3 } = await import("./editingSupport-X3U56QIY.js");
    let i6 = t6;
    await this.load();
  ...
  async convertMesh(e3, t6) {
    t6 ?? (t6 = {}), null != t6.location && m2(i2.getLogger(this), "The 'location' option of convertMesh() has been deprecated in favour of 'origin'.", { version: "4.34", replacement: "origin", warnOnce: true });
    const r3 = (e4) => {
      throw i2.getLogger(this).error(".convertMesh()", e4.message), e4;
    };
    ...
    0 === s10 && r3(new i4()), s10 > 1 && r3(new m6());
    const n8 = this.spatialReference, p6 = t6.origin ?? t6.location, d5 = await H2(p6 ?? t6.defaultOrigin ?? new _({ x: 0, y: 0, z: 0, spatialReference: n8 }), n8, t6), y3 = d5.spatialReference.isGeographic ? "local" : "georeferenced", { default: u5 } = await import("./Mesh-JFZEC4NH.js");
    s2(t6);
  ...
  async _logWarningOnPopupEnabled() {
    ...
    null == this.attributeStorageInfo ? i2.getLogger(this).warn(`Associated FeatureLayer could not be loaded and no binary attributes found. Popups will not work on ${t6}`) : i2.getLogger(this).info(`Associated FeatureLayer could not be loaded. Falling back to binary attributes for Popups on ${t6}`);
  }
  _validateElevationInfo() {
    const e3 = this.elevationInfo;
    "mesh-pyramids" === this.profile && j3(i2.getLogger(this), $2("Mesh scene layers", "relative-to-scene", e3)), j3(i2.getLogger(this), R("Scene layers", e3));
  }
...
__decorate([m3({ types: { key: "type", base: s7, typeMap: { selection: p3 } }, json: { origins: { "web-scene": { name: "layerDefinition.featureReduction", write: { allowNull: true } }, "portal-item": { name: "layerDefinition.featureReduction", write: { allowNull: true } } } } })], Te.prototype, "featureReduction", void 0), __decorate([m3({ type: [s9], json: { read: false, origins: { "web-scene": { name: "layerDefinition.rangeInfos", write: true }, "portal-item": { name: "layerDefinition.rangeInfos", write: true } } }, clonable: false })], Te.prototype, "rangeInfos", void 0), __decorate([m3({ json: { read: false } })], Te.prototype, "associatedLayer", void 0), __decorate([m3({ type: ["show", "hide"] })], Te.prototype, "listMode", void 0), __decorate([m3({ type: ["ArcGISSceneServiceLayer"] })], Te.prototype, "operationalLayerType", void 0), __decorate([m3({ json: { read: false }, readOnly: true })], Te.prototype, "type", void 0), __decorate([m3({ ...Pe.fields, readOnly: true, json: { read: false, origins: { service: { read: true } } } })], Te.prototype, "fields", void 0), __decorate([m3()], Te.prototype, "types", null), __decorate([m3()], Te.prototype, "typeIdField", null), __decorate([m3()], Te.prototype, "templates", null), __decorate([m3()], Te.prototype, "formTemplate", null), __decorate([m3({ readOnly: true })], Te.prototype, "graphicOrigin", void 0), __decorate([m3({ readOnly: true, clonable: false })], Te.prototype, "fieldsIndex", null), __decorate([m3({ type: i3, json: { read: { source: "layerDefinition.floorInfo" }, write: { target: "layerDefinition.floorInfo" } } })], Te.prototype, "floorInfo", void 0), __decorate([m3(Pe.outFields)], Te.prototype, "outFields", void 0), __decorate([m3({ type: p4, readOnly: true, json: { read: false }, clonable: false })], Te.prototype, "nodePages", void 0), __decorate([o("service", "nodePages", ["nodePages", "pointNodePages"])], Te.prototype, "readNodePages", null), __decorate([m3({ type: [a4], readOnly: true, clonable: false })], Te.prototype, "materialDefinitions", void 0), __decorate([m3({ type: [y], readOnly: true, clonable: false })], Te.prototype, "textureSetDefinitions", void 0), __decorate([m3({ type: [m7], readOnly: true, clonable: false })], Te.prototype, "geometryDefinitions", void 0), __decorate([m3({ readOnly: true })], Te.prototype, "serviceUpdateTimeStamp", void 0), __decorate([m3({ readOnly: true })], Te.prototype, "attributeStorageInfo", void 0), __decorate([m3({ readOnly: true })], Te.prototype, "statisticsInfo", void 0), __decorate([m3({ type: O.ofType(Number), nonNullable: true, json: { origins: { service: { read: false, write: false } }, name: "layerDefinition.excludeObjectIds", write: { enabled: true } } })], Te.prototype, "excludeObjectIds", void 0), __decorate([m3({ type: String, json: { origins: { service: { read: false, write: false } }, name: "layerDefinition.definitionExpression", write: { enabled: true, allowNull: true } } })], Te.prototype, "definitionExpression", void 0), __decorate([m3({ type: d4, json: { name: "layerDefinition.polygonFilter", write: { enabled: true, allowNull: true }, origins: { service: { read: false, write: false } } } })], Te.prototype, "filter", void 0), __decorate([m3({ type: String, json: { origins: { "web-scene": { read: true, write: true } }, read: false } })], Te.prototype, "path", void 0), __decorate([m3(m4)], Te.prototype, "elevationInfo", null), __decorate([m3({ readOnly: true, json: { read: false } })], Te.prototype, "effectiveCapabilities", null), __decorate([m3({ readOnly: true })], Te.prototype, "effectiveEditingEnabled", null), __decorate([m3({ type: String })], Te.prototype, "geometryType", null), __decorate([m3(p2)], Te.prototype, "labelsVisible", void 0), __decorate([m3({ type: [A], json: { origins: { service: { name: "drawingInfo.labelingInfo", read: { reader: l5 }, write: false } }, name: "layerDefinition.drawingInfo.labelingInfo", read: { reader: l5 }, write: true } })], Te.prototype, "labelingInfo", void 0), __decorate([m3(d2)], Te.prototype, "legendEnabled", void 0), __decorate([m3({ type: Number, json: { origins: { "web-document": { default: 1, write: { enabled: true, target: { opacity: { type: Number }, "layerDefinition.drawingInfo.transparency": { type: Number } } }, read: { source: ["opacity", "layerDefinition.drawingInfo.transparency"], reader(e3, t6) {
  var _a, _b;
...
} } }, "portal-item": { write: true }, service: { read: false } } } })], Te.prototype, "opacity", void 0), __decorate([m3({ type: ["Low", "High"], readOnly: true, json: { read: false, origins: { service: { read: true } } } })], Te.prototype, "priority", void 0), __decorate([m3({ type: ["Labels"], readOnly: true, json: { read: false, origins: { service: { read: true } } } })], Te.prototype, "semantic", void 0), __decorate([m3({ types: u2, json: { origins: { service: { read: { source: "drawingInfo.renderer" } } }, name: "layerDefinition.drawingInfo.renderer", write: true }, value: null })], Te.prototype, "renderer", null), __decorate([m3({ json: { read: false } })], Te.prototype, "cachedDrawingInfo", void 0), __decorate([o("service", "cachedDrawingInfo")], Te.prototype, "readCachedDrawingInfo", null), __decorate([m3({ readOnly: true, json: { read: false } })], Te.prototype, "capabilities", null), __decorate([m3({ type: Boolean, json: { read: false } })], Te.prototype, "editingEnabled", null), __decorate([m3({ readOnly: true, json: { write: false, read: false } })], Te.prototype, "infoFor3D", null), __decorate([m3({ readOnly: true, json: { write: false, read: false } })], Te.prototype, "relationships", null), __decorate([m3(l3)], Te.prototype, "popupEnabled", void 0), __decorate([m3({ type: q, json: { name: "popupInfo", write: true } })], Te.prototype, "popupTemplate", void 0), __decorate([m3({ readOnly: true, json: { read: false } })], Te.prototype, "defaultPopupTemplate", null), __decorate([m3(I)], Te.prototype, "attributeTableTemplate", void 0), __decorate([m3({ type: String, json: { read: false } })], Te.prototype, "objectIdField", void 0), __decorate([o("service", "objectIdField", ["objectIdField", "fields"])], Te.prototype, "readObjectIdField", null), __decorate([m3({ type: String, json: { read: false } })], Te.prototype, "globalIdField", void 0), __decorate([o("service", "globalIdField", ["globalIdField", "fields"])], Te.prototype, "readGlobalIdField", null), __decorate([m3({ readOnly: true, type: String, json: { read: false } })], Te.prototype, "displayField", null), __decorate([m3({ type: String, json: { read: false } })], Te.prototype, "profile", void 0), __decorate([o("service", "profile", ["store.profile"])], Te.prototype, "readProfile", null), __decorate([m3({ readOnly: true, type: String, json: { origins: { service: { read: { source: "store.normalReferenceFrame" } } }, read: false } })], Te.prototype, "normalReferenceFrame", void 0), __decorate([m3(s4)], Te.prototype, "screenSizePerspectiveEnabled", void 0), __decorate([m3({ json: { read: false, origins: { service: { read: true } } } })], Te.prototype, "serviceItemId", void 0), __decorate([m3(f2)], Te.prototype, "useViewTime", null), Te = __decorate([a3("esri.layers.SceneLayer")], Te);
...
//# sourceMappingURL=SceneLayer-BVB4JZWF.js.map
