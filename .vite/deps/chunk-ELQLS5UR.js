...
var u = class _u {
  ...
  static toUnitRGBA(t, r2) {
    return null == t ? null : (r2 ?? (r2 = [0, 0, 0, 0]), r2[0] = t.r / 255, r2[1] = t.g / 255, r2[2] = t.b / 255, r2[3] = null != t.a ? t.a : 1, r2);
  }
  constructor(t) {
  ...
  toHex(t) {
    const r2 = (t == null ? void 0 : t.capitalize) ?? false, s3 = (t == null ? void 0 : t.digits) ?? 6, i = 3 === s3 || 4 === s3, n = 4 === s3 || 8 === s3, o2 = `#${h2(this.r, i)}${h2(this.g, i)}${h2(this.b, i)}${n ? h2(Math.round(255 * this.a), i) : ""}`;
...
//# sourceMappingURL=chunk-ELQLS5UR.js.map
