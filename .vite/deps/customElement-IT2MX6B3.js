...
var _DatePickerMonth = class _DatePickerMonth extends LitElement {
  constructor() {
    super();
    this.storeDayRef = (el) => {
      if ((el == null ? void 0 : el.active) && this.activeFocus) {
        el.setFocus();
      }
    };
...
_DatePickerMonth.styles = styles;
...
@esri/calcite-components/dist/components/calcite-date-picker-month/customElement.js:
  ...
  v3.3.3 *)
*/
//# sourceMappingURL=customElement-IT2MX6B3.js.map
