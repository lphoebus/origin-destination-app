import {
  ...
  s3 as s6,
  u
} from "./chunk-UXWJTRFS.js";
import {
  T
} from "./chunk-SXXVFEND.js";
import {
  r as r2,
  t as t2
...
var G;
async function H3() {
  null == G && (G = await import("./operators-STXZIIFE.js"), await G.loadAll());
}
function F(H6, F4) {
...
function ge2(e5, n7) {
  ...
  switch ("VariableDeclaration" === n7.left.type ? (r5 = oe2(e5, n7.left.declarations[0].id), l4 += ce(e5, n7.left)) : r5 = re2(e5, n7.left), r5.scope) {
    ...
    case "global":
      ...
      break;
    default:
      throw n2(r5.scope), new s(null, "NeverReach", n7.left);
  }
...
function we(e5, n7) {
  ...
  switch (Oe(r5), r5.scope) {
    ...
    default:
      throw n2(r5.scope), new s(null, "NeverReach", n7.argument);
  }
}
function be(e5, n7) {
  let t5 = "lastStatement = lc.voidOperation; \n";
...
function Ae2(e5, n7) {
  ...
  switch (Oe(r5), r5.scope) {
    ...
    default:
      throw n2(r5.scope), new s(null, "NeverReach", n7.id);
  }
}
function ke(e5, n7) {
  try {
...
function Re2(e5, n7) {
  ...
  switch (Oe(t5), t5.scope) {
    ...
    default:
      throw n2(t5.scope), new s(null, "NeverReach", n7);
  }
}
function Le2(e5, n7) {
  try {
    ...
    switch (t5.scope) {
      ...
      case "global":
        ...
        break;
      default:
        throw n2(t5.scope), new s(null, "NeverReach", n7.callee);
    }
    let o6 = "[";
...
async function nn() {
  return Ze([await import("./geomasync-AASX62GA.js")], "async"), true;
}
...
async function q3() {
  await nn(), x2 = await import("./arcadeAsyncRuntime-PIHIBE73.js");
...
async function X2() {
  await N2();
  const [e5, t5, n7, s9, a3, o6] = await Promise.all([import("./featureSetUtils-3I3BKLBA.js"), import("./featuresetbase-6WVU7GK3.js"), import("./featuresetgeom-AOTV5KBG.js"), import("./featuresetstats-UW5MQ3X3.js"), import("./featuresetstring-ANMOME52.js"), import("./knowledgegraph-X7W3DTHE.js")]);
...
//# sourceMappingURL=chunk-CLBLRT24.js.map
