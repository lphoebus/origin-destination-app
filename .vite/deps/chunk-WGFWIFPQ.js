...
function g(e2, s2, o2) {
  ...
  for (let u2 = 0; u2 < l2.length; u2++) {
    ...
    if (null == e3) continue;
    const c3 = ((_a = i2 == null ? void 0 : i2[u2]) == null ? void 0 : _a.minValue) ?? b2[0], m2 = ((_b = i2 == null ? void 0 : i2[u2]) == null ? void 0 : _b.maxValue) ?? b2[1];
    if (c3 > e3 + Number.EPSILON || m2 < e3 - Number.EPSILON) continue;
    const p = f2[u2] || a2.slice(), d = l2[u2], N = o2 == null ? void 0 : o2.customFloatTolerance;
    if (h2 && 0 !== N) {
      let u3 = N;
  ...
  if (g2) {
    ...
    (o2 == null ? void 0 : o2.matchAllNoData) ? e2.mask = t2 && t2.length > 1 ? m(t2) : a2 : (e2.bandMasks = t2, e2.mask = a2);
  }
  function m(t2) {
...
//# sourceMappingURL=chunk-WGFWIFPQ.js.map
