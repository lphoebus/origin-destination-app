...
import {
  ...
  p as p3,
  v as v2
} from "./chunk-XJ5FUH2J.js";
import "./chunk-6M2B5QQD.js";
import {
  $,
  R as R2,
  j as j2
...
async function n10(n11, m11, p19) {
  var _a, _b;
  const f11 = f5(n11), u9 = u({ ...f11 == null ? void 0 : f11.query, f: "json" }), h3 = s5(u9, p19), d8 = `${f11 == null ? void 0 : f11.path}/${m11}/info`, c13 = H(`${d8}`, h3), g4 = H(`${d8}/keyProperties`, h3), x3 = await Promise.allSettled([c13, g4]), y10 = "fulfilled" === x3[0].status ? x3[0].value.data : null, v4 = "fulfilled" === x3[1].status ? x3[1].value.data : null;
  let P4 = null;
  ...
  let He2 = class extends h3 {
    ...
    get rasterFields() {
      ...
      if (this._isVectorDataSet()) {
        const i13 = (_d = (_c = t6 == null ? void 0 : t6.multidimensionalInfo) == null ? void 0 : _c.variables[0].unit) == null ? void 0 : _d.trim(), r3 = d3(i13), s13 = $2();
        e5.push(r3, s13);
      }
    ...
    async calculateVolume(e5, t6) {
      if (!(await this._fetchCapabilities(t6 == null ? void 0 : t6.signal)).operations.supportsCalculateVolume) throw new s("imagery-layer:compute-pixel-space-locations", "this operation is not supported on the input image service");
    ...
    fetchRasterAttributeTable(e5) {
      return this.version < 10.1 ? Promise.reject(new s("#fetchRasterAttributeTable()", "Failed to get rasterAttributeTable")) : H(Ge(this.parsedUrl) + "/rasterAttributeTable", { query: this._getQueryParams({ renderingRule: this.version >= 10.3 ? e5 == null ? void 0 : e5.rasterFunction : null }) }).then((e6) => g.fromJSON(e6.data));
    }
    ...
    async getSamples(e5, t6) {
      const i12 = await this._fetchCapabilities(t6 == null ? void 0 : t6.signal);
      if (!(i12 == null ? void 0 : i12.operations.supportsGetSamples)) throw new s("imagery-layer:get-samples", "getSamples operation is not supported on the input image service");
      e5 = a(e5);
    ...
    async queryVisibleRasters(e5, t6) {
      ...
      try {
        ...
        }), y11 = new b2({ objectIds: g5, returnGeometry: true, outSpatialReference: e5.outSpatialReference, outFields: [m13] }), R4 = await this.queryRasters(y11);
    ...
    async _fetchServiceInfo(e5) {
      ...
      if (((_a = t6.capabilities) == null ? void 0 : _a.toLowerCase().split(",").map((e6) => e6.trim()).indexOf("tilesonly")) > -1) throw new s("imagery-layer:fetch-service-info", "use ImageryTileLayer to open tiles-only image services");
    ...
    _configRenderer(e5) {
      ...
      if (!t6 && !this.pixelFilter || this._isVectorDataSet()) {
        const t7 = (_b = (_a = this.mosaicRule) == null ? void 0 : _a.multidimensionalDefinition) == null ? void 0 : _b[0].variableName, r3 = q({ variableName: t7, rasterFunctionName: (_c = this.rasterFunction) == null ? void 0 : _c.functionName, presetRenderers: this.presetRenderers });
...
var $3 = class extends p(l9(t(b(j(o5(He(i7(f4(s8(l8(l3(l2(b5))))))))))))) {
  constructor(...e5) {
    super(...e5), this.graphicOrigin = new s11(this), this.isReference = null, this.operationalLayerType = "ArcGISImageServiceLayer", this.popupEnabled = true, this.popupTemplate = null, this.screenSizePerspectiveEnabled = true, this.type = "imagery", this._debouncedSaveOperations = L(async (e6, r3, t6) => {
      const { save: o6, saveAs: i12 } = await import("./imageryUtils-Z5SWCLAA.js");
      switch (e6) {
        case 0:
          return o6(this, r3);
        case 1:
  ...
  createPopupTemplate(e5) {
    ...
    return (p19 == null ? void 0 : p19.fieldInfos) && n11 && b3(p19.fieldInfos, n11), p19;
  }
  queryFeatures(e5, r3) {
...
//# sourceMappingURL=ImageryLayer-6BFKMGZ2.js.map
