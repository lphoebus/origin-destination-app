...
var r3 = class {
  ...
  _writePrimitiveNode(r5, i3, n4 = false) {
    ...
    const s6 = 1 === i3.children.length && ((_a15 = i3.children[0]) == null ? void 0 : _a15.type) === i3.type;
...
var P2 = class {
  ...
  get locations() {
    var _a15;
    return [...this.vertexInput.inputCtor.locations, ...((_a15 = this.computeInput) == null ? void 0 : _a15.inputCtor.locations) ?? []];
  }
  get locationsMap() {
...
//# sourceMappingURL=chunk-WQYOTJRX.js.map
