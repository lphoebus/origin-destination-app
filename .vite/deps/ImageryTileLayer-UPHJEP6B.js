import {
  ...
  t as t4,
  u as u4
} from "./chunk-W5XXMJFL.js";
import "./chunk-6MSZOGGP.js";
import {
  c as c4,
  f as f4,
  o as o3
  ...
  async _buildMDimStats(t7, e3, s7) {
    for (let i8 = 0; i8 < e3.variables.length; i8++) {
      ...
      const o6 = r6.dimensions.map((t8) => {
        var _a, _b;
        return new p2({ variableName: r6.name, dimensionName: t8.name, values: [((_a = t8.values) == null ? void 0 : _a[0]) ?? ((_b = t8.extent) == null ? void 0 : _b[0])], isSlice: true });
...
var Y2 = class extends p(t(b(j2(o3(s5(X2(i4(l6(l5(f3(l3(l2(b3))))))))))))) {
  constructor(...e3) {
    super(...e3), this._primaryRasters = [], this.graphicOrigin = new s6(this), this.legendEnabled = true, this.isReference = null, this.listMode = "show", this.sourceJSON = null, this.version = null, this.type = "imagery-tile", this.operationalLayerType = "ArcGISTiledImageServiceLayer", this.popupEnabled = true, this.popupTemplate = null, this.screenSizePerspectiveEnabled = true, this.fields = null, this.source = void 0, this._debouncedSaveOperations = L(async (e4, t7, r6) => {
      const { save: s7, saveAs: i8 } = await import("./imageryUtils-Z5SWCLAA.js");
      switch (e4) {
        case 0:
          return s7(this, t7);
        case 1:
  ...
  get rasterFields() {
    var _a, _b;
    const e3 = [o2("Pixel Value"), c3("Raw Pixel Value")], t7 = ((_a = this.raster) == null ? void 0 : _a.rasterInfo) ?? this.serviceRasterInfo, r6 = t7 == null ? void 0 : t7.attributeTable;
    if (r6) {
      const t8 = v4(r6);
      e3.push(...t8);
    }
    ...
    if (("vector-magdir" === s7 || "vector-uv" === s7) && null != i8) {
      const t8 = (_b = i8.variables[0].unit) == null ? void 0 : _b.trim(), r7 = d3(t8), s8 = $2();
      e3.push(r7, s8);
    }
    if (i8) {
      const t8 = p3(i8);
  ...
  createPopupTemplate(e3) {
    const { rasterFields: t7 } = this, r6 = (e3 == null ? void 0 : e3.visibleFieldNames) ?? new Set(t7.map(({ name: e4 }) => e4).filter((e4) => e4 !== i3.rawServicePixelValue)), s7 = d2({ fields: t7, title: this.title }, { ...e3, visibleFieldNames: r6 }), { rasterInfo: i8 } = this.raster;
    return (s7 == null ? void 0 : s7.fieldInfos) && i8 && b2(s7.fieldInfos, i8), s7;
  }
...
//# sourceMappingURL=ImageryTileLayer-UPHJEP6B.js.map
