...
function u(e, n3) {
  return (n3 == null ? void 0 : n3.mode) ? n3.mode : r(e).mode;
}
function i(e, n3) {
...
function c(e) {
  const n3 = m(e), t2 = s(e.geometry, n3), o = null != n3 && "on-the-ground" !== t2 ? z(n3) : 0, r2 = n3 == null ? void 0 : n3.featureExpressionInfo;
...
function v(e) {
  var _a;
  return "0" === ((_a = e == null ? void 0 : e.featureExpressionInfo) == null ? void 0 : _a.expression);
}
function g(e) {
  if (!e) return false;
  if ("on-the-ground" === e.mode) return false;
  const n3 = (e == null ? void 0 : e.featureExpressionInfo) ? e.featureExpressionInfo.expression : null;
  return !(!n3 || "0" === n3);
}
function m(e) {
...
function h(e, n3) {
  return p(e == null ? void 0 : e.offset, e == null ? void 0 : e.unit, n3);
}
function x(e, n3, t2) {
  if (!(t2 == null ? void 0 : t2.mode)) return;
...
function $(e, n3, t2) {
  return (t2 == null ? void 0 : t2.mode) === n3 ? `${e} do not support ${n3} elevation mode` : null;
}
function R(e, n3) {
  return null != (n3 == null ? void 0 : n3.featureExpressionInfo) && "0" !== n3.featureExpressionInfo.expression ? `${e} do not support featureExpressionInfo` : null;
}
function j(e, n3) {
  n3 && e.warn(".elevationInfo=", n3);
}
function z(e) {
  return ((e == null ? void 0 : e.offset) ?? 0) * n(e == null ? void 0 : e.unit);
}
...
//# sourceMappingURL=chunk-WXGZCYG3.js.map
