...
async function e(e2, u2, m) {
  const p2 = f(e2), a = { ...u2.toJSON(), f: "json" }, c = u({ ...p2.query, ...a }), f2 = s(c, { ...m, method: "post" }), n = `${p2.path}/circuits/create`, { data: j } = await H(n, f2);
  return p.fromJSON(j);
}
export {
  e as createCircuit
};
//# sourceMappingURL=createCircuit-H3Y65WSG.js.map
