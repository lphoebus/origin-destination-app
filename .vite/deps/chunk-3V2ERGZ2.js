...
var y5 = { types: D, json: { write: { writer: i3 }, origins: { "web-scene": { types: F, write: { writer: i3 }, read: { reader: s3({ types: F }) } } } } };
var m7 = n({ json: { origins: { "web-scene": { write: { isRequired: true } } } } }, y5);
var n7 = { types: { base: c, key: "type", typeMap: { "simple-fill": x2.typeMap["simple-fill"], "picture-fill": x2.typeMap["picture-fill"], "polygon-3d": x2.typeMap["polygon-3d"], cim: x2.typeMap.cim } }, json: { write: { writer: i3 }, origins: { "web-scene": { type: g, write: { writer: i3 } } } } };
...
//# sourceMappingURL=chunk-3V2ERGZ2.js.map
