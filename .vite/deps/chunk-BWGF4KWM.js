...
var h = class t {
  constructor(t2, r4, s, i2) {
    this._context = t2, this._indexBuffer = s, this._buffers = r4 instanceof Map ? r4 : /* @__PURE__ */ new Map([["geometry", r4]]), this._baseInstances = null == i2 ? /* @__PURE__ */ new Map() : "number" == typeof i2 ? /* @__PURE__ */ new Map([["geometry", i2]]) : i2, this.locations = r2(r3(this._buffers));
  }
  get glName() {
    return this._glName;
  }
  ...
  getByteLength(e) {
    var _a;
    return ((_a = this.buffer(e)) == null ? void 0 : _a.sizeBytes) ?? 0;
  }
  vertexCount(e) {
  ...
  get usedMemory() {
    var _a;
    return Array.from(this._buffers.values()).reduce((e, t2) => e + t2.usedMemory, ((_a = this._indexBuffer) == null ? void 0 : _a.usedMemory) ?? 0 + (this._buffers.size + (this._indexBuffer ? 1 : 0)) * y);
  }
  dispose() {
    this._context ? (this._buffers.forEach((e) => e.dispose()), this._buffers.clear(), this._indexBuffer = r(this._indexBuffer), this.disposeVAOOnly()) : (this._glName || this._buffers.size > 0) && f().warn("Leaked WebGL VAO");
  }
  disposeVAOOnly() {
...
//# sourceMappingURL=chunk-BWGF4KWM.js.map
