...
async function u2(u3, e, m) {
  const p2 = f(u3), a = { ...e.toJSON(), f: "json" }, c = u({ ...p2.query, ...a }), f2 = s(c, { ...m, method: "post" }), n = `${p2.path}/circuits/alter`, { data: j } = await H(n, f2);
  return p.fromJSON(j);
}
export {
  u2 as alterCircuit
};
//# sourceMappingURL=alterCircuit-JS6MYDLW.js.map
