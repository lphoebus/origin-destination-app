...
async function H(e) {
  ...
  e.forEach(({ type: e2 }) => {
    switch (l(e2)) {
      case "CatalogLayer":
        r.push(import("./CatalogLayer-Z2OFFWQG.js").then((e3) => e3.default));
        break;
      case "FeatureLayer":
        r.push(import("./@arcgis_core_layers_FeatureLayer.js").then((e3) => e3.default));
        break;
      case "OrientedImageryLayer":
        r.push(import("./OrientedImageryLayer-GMS7NTZA.js").then((e3) => e3.default));
    }
  });
...
async function ne(e, r, a) {
  ...
  r.url = ("FeatureServer" === (i2 == null ? void 0 : i2.serverType) ? t : `${t}/${n2}`) ?? null, r.title || (r.title = s3), r.extent = null, l3 || null == o2 || (r.extent = await l2(o2)), ae([e], r, a);
}
function se(e, r) {
  for (const o2 of e) {
...
//# sourceMappingURL=featureLayerUtils-QTB66BL3.js.map
