...
var w2 = class extends l2 {
  ...
  async setup(e5) {
    ...
    return this._elevationAligner = i4(u2, { elevationInfo: null != e5.elevationInfo ? c2.fromJSON(e5.elevationInfo) : null, alignPointsInFeatures: this._alignPointsInFeatures }), this._elevationFilter = r(u2), this.addHandles([l(() => this._featureFetcher.availability, (e6) => this.emit("notify-availability", { availability: e6 }), U), l(() => this.updating, () => this._notifyUpdating())]), this._whenSetup.resolve(), this._isInitializing = false, this.configure(e5.configuration);
  }
  async configure(e5) {
...
//# sourceMappingURL=FeatureServiceSnappingSourceWorker-YALJQOZR.js.map
