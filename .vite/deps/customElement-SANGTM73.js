...
var _Autocomplete = class _Autocomplete extends LitElement {
  ...
  async scrollContentTo(options) {
    var _a;
    (_a = this.transitionEl) == null ? void 0 : _a.scrollTo(options);
  }
  async selectText() {
  ...
  inputHandler(event) {
    ...
    event.stopPropagation();
    this.inputValue = event.target.value;
    this.open = ((_a = this.inputValue) == null ? void 0 : _a.length) > 0;
...
@esri/calcite-components/dist/components/calcite-autocomplete/customElement.js:
  ...
  v3.3.3 *)
*/
//# sourceMappingURL=customElement-SANGTM73.js.map
