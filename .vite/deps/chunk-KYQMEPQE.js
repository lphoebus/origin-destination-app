...
function e(r2, e2, n2) {
  return !!r2.some((r3) => {
    ...
    const o = ((_c = (_b = (_a = r3.layer) == null ? void 0 : _a.capabilities) == null ? void 0 : _b.exportMap) == null ? void 0 : _c.supportsSublayerOrderBy) ?? false;
...
function i(r2, e2) {
  if (!(r2 == null ? void 0 : r2.length) || null == e2) return true;
...
function n(r2) {
  return !!r2 && r2.some((r3) => {
    var _a;
    return null != r3.minScale || null != ((_a = r3.layerDefinition) == null ? void 0 : _a.minScale);
  });
}
...
//# sourceMappingURL=chunk-KYQMEPQE.js.map
