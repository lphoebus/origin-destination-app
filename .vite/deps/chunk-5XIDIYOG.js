...
function q(e) {
  ...
  for (let s2 = 0; s2 < p.length; s2++) {
    ...
    h.forAll((n4) => {
      ...
      0 === s2 && n4.ticks++;
      n4.phases[r3] && (l.elapsedFrameTime = n(performance.now() - e), l.deltaTime = 0 === n4.ticks ? n(0) : t2, (_a = n4.phases[r3]) == null ? void 0 : _a.call(n4, l));
...
//# sourceMappingURL=chunk-5XIDIYOG.js.map
