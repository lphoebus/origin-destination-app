...
function s() {
  return t ?? (t = (async () => {
    const s3 = await import("./basis_encoder-BJJGHQVK.js"), t2 = await s3.default({ locateFile: (s4) => n(`esri/libs/basisu/${s4}`) });
...
function e() {
  return n2 ?? (n2 = (async () => {
    const e2 = await import("./dxt_encoder-E3T4ABTY.js");
...
//# sourceMappingURL=TextureCompressionWorker-47RMCITW.js.map
