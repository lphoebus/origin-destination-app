...
function focusFirstTabbable(element, includeContainer, options) {
  var _a;
  (_a = getFirstTabbable(element, includeContainer)) == null ? void 0 : _a.focus(options);
}
...
function focusFirstFocusable(element, includeContainer, options) {
  var _a;
  (_a = getFirstFocusable(element, includeContainer)) == null ? void 0 : _a.focus(options);
}
...
function hasVisibleContent(element) {
  ...
  for (const node of element.childNodes) {
    if (node.nodeType === Node.TEXT_NODE && ((_a = node.textContent) == null ? void 0 : _a.trim()) !== "" || node.nodeType === Node.ELEMENT_NODE) {
      return true;
    }
  }
  return false;
...
@esri/calcite-components/dist/chunks/dom.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-VYH67NUG.js.map
