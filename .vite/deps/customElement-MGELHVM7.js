...
var _InputNumber = class _InputNumber extends LitElement {
  ...
  async selectText() {
    var _a;
    (_a = this.childNumberRef.value) == null ? void 0 : _a.select();
  }
  ...
  setNumberValue({ committing = false, nativeEvent, origin, previousValue, value }) {
    ...
    const childInputValue = (_c = this.childNumberRef.value) == null ? void 0 : _c.value;
    if (childInputValue) {
...
@esri/calcite-components/dist/components/calcite-input-number/customElement.js:
  (*! All material copyright ESRI, All Rights Reserved, unless otherwise specified.
  See https://github.com/Esri/calcite-design-system/blob/dev/LICENSE.md for details.
  v3.3.3 *)
*/
//# sourceMappingURL=customElement-MGELHVM7.js.map
