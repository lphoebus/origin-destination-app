...
async function c(c2, u2, e) {
  const m = f(c2), n = u2.toJSON();
  u2.circuits && (n.circuits = JSON.stringify(u2.circuits));
  const p2 = { ...n, f: "json" }, f2 = u({ ...m.query, ...p2 }), a = s(f2, { ...e, method: "post" }), d = `${m.path}/circuits/delete`, { data: j } = await H(d, a);
  return p.fromJSON(j);
}
export {
  c as deleteCircuits
};
//# sourceMappingURL=deleteCircuits-U76XB5W5.js.map
