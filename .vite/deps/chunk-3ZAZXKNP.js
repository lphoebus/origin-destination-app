...
function I(e, t) {
  var _a, _b;
  const o = (_a = t.colorRamp) == null ? void 0 : _a.type;
  switch (o) {
    case "CIMMultipartColorRamp":
      (_b = t.colorRamp.colorRamps) == null ? void 0 : _b.forEach((t2) => {
...
function h2(e, t, n) {
  ...
  if (i == null ? void 0 : i.symbolLayers) for (const l of i.symbolLayers) {
    ...
    switch (l.type) {
      ...
      case "CIMPictureFill":
        ...
        break;
      case "CIMVectorMarker":
        (_a = l.markerGraphics) == null ? void 0 : _a.forEach((e3) => {
          h2(e3.symbol, t, n);
        });
        break;
      case "CIMSolidStroke":
...
function d(e, t) {
  var _a, _b;
  const o = (_a = e.colorRamp) == null ? void 0 : _a.type;
  switch (o) {
    case "CIMMultipartColorRamp":
      (_b = e.colorRamp.colorRamps) == null ? void 0 : _b.forEach((e2) => {
...
function S(e, o, a = false) {
  const n = y(e);
  if (a && (o = 360 - o), "CIMTextSymbol" !== (n == null ? void 0 : n.type)) {
    if ("CIMPointSymbol" === (n == null ? void 0 : n.type) && n.symbolLayers) {
...
//# sourceMappingURL=chunk-3ZAZXKNP.js.map
