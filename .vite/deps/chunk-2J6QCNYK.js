...
var t = class _t extends o {
  constructor(e, r3) {
    super(a(r3) + e.message, { cause: e }), this.loc = null, Error.captureStackTrace && Error.captureStackTrace(this, _t), (r3 == null ? void 0 : r3.loc) && (this.loc = r3.loc);
  }
};
var n = class _n extends Error {
  constructor(o3, t3, s2, c2) {
    super("Execution error - " + a(s2) + r(r2[t3], c2)), this.loc = null, this.declaredRootClass = "esri.arcade.arcadeexecutionerror", Error.captureStackTrace && Error.captureStackTrace(this, _n), (s2 == null ? void 0 : s2.loc) && (this.loc = s2.loc);
  }
};
function a(e) {
  var _a, _b;
...
var s = class _s extends Error {
  constructor(o3, t3, n2, c2) {
    super("Compilation error - " + a(n2) + r(r2[t3], c2)), this.loc = null, this.declaredRootClass = "esri.arcade.arcadecompilationerror", Error.captureStackTrace && Error.captureStackTrace(this, _s), (n2 == null ? void 0 : n2.loc) && (this.loc = n2.loc);
  }
};
...
function i(e, r3, o3) {
  return "esri.arcade.arcadeexecutionerror" === o3.declaredRootClass || "esri.arcade.arcadecompilationerror" === o3.declaredRootClass ? null === o3.loc && (r3 == null ? void 0 : r3.loc) ? new t(o3, { cause: o3 }) : o3 : ("esri.arcade.featureset.support.featureseterror" === o3.declaredRootClass || "esri.arcade.featureset.support.sqlerror" === o3.declaredRootClass || o3.declaredRootClass, (r3 == null ? void 0 : r3.loc) ? new t(o3, { cause: o3 }) : o3);
}
...
//# sourceMappingURL=chunk-2J6QCNYK.js.map
