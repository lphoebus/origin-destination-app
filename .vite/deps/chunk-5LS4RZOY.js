...
var v = class extends l2(s2(b)) {
  ...
  async _createAssociationFeatureObjects(t2, e2, o3, r2, s4, i) {
    ...
    return await Promise.all(t2.toArray().map(async (t3) => {
      ...
      await Promise.all(i2.map(async (e4) => {
        var _a, _b;
        const o4 = (_b = (_a = this.utilityNetwork) == null ? void 0 : _a.getTerminalById(s5 == null ? void 0 : s5.terminalId)) == null ? void 0 : _b.name, r4 = e4.sourceLayer && "getFeatureTitle" in e4.sourceLayer && await e4.sourceLayer.getFeatureTitle(e4) || t(e4);
  ...
  async _queryAssociations(t2) {
    ...
    if (await Promise.allSettled([e2 == null ? void 0 : e2.load(), s4 == null ? void 0 : s4.load()]), this._clearAssociations(), !(i && e2 && r2 && s4 && o3)) return;
    ...
    const l3 = await (s4 == null ? void 0 : s4.queryAssociations({ elements: [n], types: Array.from(c) }, { signal: t2 == null ? void 0 : t2.signal })), u = /* @__PURE__ */ new Map(), y2 = /* @__PURE__ */ new Map();
    r2.forEach((t3) => {
  ...
  async _countAssociatedFeatureCount(t2, e2, o3, r2, s4) {
    ...
    return t2.queryFeatureCount({ where: i, outFields: ["*"], returnGeometry: false }, { signal: s4 == null ? void 0 : s4.signal });
  }
  ...
  async _queryAssociatedFeatures(t2, e2) {
    ...
    if (await Promise.allSettled([o3 == null ? void 0 : o3.load(), i == null ? void 0 : i.load()]), !(a2 && o3 && s4 && i)) return;
  ...
  _shouldDiscardNetworkElement(t2, e2, o3) {
    var _a;
    if (!t2) return false;
    const { networkSourceIdsInUse: r2 } = this, { networkSourceId: s4 } = t2, i = (_a = o3.get(e2)) == null ? void 0 : _a.associatedNetworkSourceId, a2 = r2.has(s4);
  ...
  _getFeatureQueryWhereClause(t2, e2, o3, r2) {
    ...
    return [s4 ? o(s4, e2) : null, n ? `(${i == null ? void 0 : i.name} = ${o3})` : null, n && c ? `(${a2 == null ? void 0 : a2.name} = ${r2})` : null].filter(Boolean).join(" AND ");
  }
};
...
//# sourceMappingURL=chunk-5LS4RZOY.js.map
