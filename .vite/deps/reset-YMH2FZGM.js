...
async function i(i2, n, f2) {
  const m = f(i2), p2 = n.toJSON();
  n.objects && (p2.objects = JSON.stringify(n.objects));
  const u2 = { ...p2, f: "json" }, c = u({ ...m.query, ...u2 }), j = s(c, { ...f2, method: "post" }), a = `${m.path}/unitIdentifiers/reset`, { data: d } = await H(a, j);
  return p.fromJSON(d);
}
export {
  i as reset
};
//# sourceMappingURL=reset-YMH2FZGM.js.map
