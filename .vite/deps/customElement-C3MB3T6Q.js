...
var _TabNav = class _TabNav extends LitElement {
  ...
  internalActivateTabHandler(event) {
    ...
    if ((currentSelectedTabTitle == null ? void 0 : currentSelectedTabTitle.id) !== activatedTabTitle.id && event.detail.userTriggered) {
  ...
  onSlotChange() {
    ...
    tabTitles.forEach((child) => {
      var _a2;
      (_a2 = this.intersectionObserver) == null ? void 0 : _a2.observe(child);
    });
...
@esri/calcite-components/dist/components/calcite-tab-nav/customElement.js:
  ...
  v3.3.3 *)
*/
//# sourceMappingURL=customElement-C3MB3T6Q.js.map
