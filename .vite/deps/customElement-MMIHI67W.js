...
var _InlineEditable = class _InlineEditable extends LitElement {
  constructor() {
    super();
  ...
  async handleDefaultSlotChange(event) {
    ...
    this.scale = this.scale || ((_a = this.inputEl) == null ? void 0 : _a.scale) || "m";
  }
  onLabelClick() {
    this.setFocus();
  }
  enableEditing() {
    var _a, _b;
    this.valuePriorToEditing = (_a = this.inputEl) == null ? void 0 : _a.value;
    this.editingEnabled = true;
    (_b = this.inputEl) == null ? void 0 : _b.setFocus();
  ...
  cancelEditing() {
    ...
    this.disableEditing();
    (_a = this.enableEditingButtonRef.value) == null ? void 0 : _a.setFocus();
  ...
  escapeKeyHandler(event) {
    ...
    if (event.key === "Tab" && this.shouldShowControls) {
      ...
      if (!!event.shiftKey && event.target === this.cancelEditingButtonRef.value) {
        event.preventDefault();
        (_a = this.inputEl) == null ? void 0 : _a.setFocus();
      }
    }
  }
...
_InlineEditable.properties = { afterConfirm: [0, {}, { attribute: false }], controls: [7, {}, { reflect: true, type: Boolean }], disabled: [7, {}, { reflect: true, type: Boolean }], editingEnabled: [7, {}, { reflect: true, type: Boolean }], loading: [7, {}, { reflect: true, type: Boolean }], messageOverrides: [0, {}, { attribute: false }], scale: [3, {}, { reflect: true }] };
_InlineEditable.shadowRootOptions = { mode: "open", delegatesFocus: true };
_InlineEditable.styles = styles;
var InlineEditable = _InlineEditable;
...
@esri/calcite-components/dist/components/calcite-inline-editable/customElement.js:
  ...
  v3.3.3 *)
*/
//# sourceMappingURL=customElement-MMIHI67W.js.map
