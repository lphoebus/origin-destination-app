...
var styles = css`:host{--calcite-internal-color-focus: var( --calcite-color-focus, var(--calcite-ui-focus-color, var(--calcite-color-brand)) )}:host{display:block}:host(:focus){outline:2px solid transparent;outline-offset:2px}:host([hidden]){display:none}[hidden]{display:none}`;
var _Tree = class _Tree extends LitElement {
  constructor() {
    super();
    this.items = [];
    this.lines = false;
...
_Tree.properties = { child: [7, {}, { reflect: true, type: Boolean }], lines: [7, {}, { reflect: true, type: Boolean }], parentExpanded: [5, {}, { type: Boolean }], scale: [3, {}, { reflect: true }], selectedItems: [0, {}, { attribute: false }], selectionMode: [3, {}, { reflect: true }] };
_Tree.styles = styles;
var Tree = _Tree;
...
@esri/calcite-components/dist/components/calcite-tree/customElement.js:
  ...
  v3.3.3 *)
*/
//# sourceMappingURL=customElement-BR325GK5.js.map
