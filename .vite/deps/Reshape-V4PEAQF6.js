import {
  h as h7
} from "./chunk-5HBUX3WC.js";
import {
  j as j3,
  l as l6
} from "./chunk-MNEPBMDH.js";
import {
  a as a3,
  t as t4
...
import {
  ...
  i as i4,
  p as p4
} from "./chunk-4MBVAYI2.js";
import {
  i as i5
} from "./chunk-MM3LFHJB.js";
import {
  f as f6
} from "./chunk-XU6B4OKC.js";
import {
  h as h6,
  x as x3
} from "./chunk-3MJVUBQV.js";
import {
  e as e6,
  g,
  w2
...
import "./chunk-IK2OCNRM.js";
import "./chunk-Z57QGAV6.js";
import {
  y as y3
...
import "./chunk-4WLAEE7K.js";
import "./chunk-FEKGL2F6.js";
import "./chunk-6ZWDX5WZ.js";
import "./chunk-MD3QCONO.js";
import "./chunk-MPILMNLY.js";
...
async function L(e8, i7, a4) {
  ...
  if (null == d5) return _3().error("editing:cannot-hide-graphic", "Unable to hide original graphic because it has no objectId."), e();
  let c3 = null;
  function h9(e9) {
    c3 == null ? void 0 : c3.abort(), c3 = d2(async (i8) => {
      var _a;
      const t5 = await b2(a4, o);
      s2(i8), t5 && ((_a = t5.setVisibility) == null ? void 0 : _a.call(t5, d5, e9));
    });
  }
  return await F3(a4, i7), h9(false), t([j4(a4, i7, (e9) => h9(!e9)), e(async () => {
    h9(true);
...
function j4(e8, i7, t5) {
  if ("3d" === e8.type) {
    ...
    return t([e8.trackGraphicState(r3), l(() => r3.displaying, t5)]);
  }
  return l(() => i7.visible, t5);
}
...
var _t = class extends l2 {
  ...
  initialize() {
    ...
    }, { once: true, initial: true }), l(() => this.graphic, () => this.refresh()), l(() => this.layer, (t6, e8) => {
    ...
    }), l(() => this.enableMidpoints, () => this.refresh()), g2(this.tooltip, () => this._tooltipsContext), l(() => this.view.effectiveTheme.accentColor, () => this._updateSymbolsForTheme(), h2), this._updateHandlesOnExternalGeometryChange]), this._updateTooltip();
  }
  destroy() {
    var _a;
...
//# sourceMappingURL=Reshape-V4PEAQF6.js.map
