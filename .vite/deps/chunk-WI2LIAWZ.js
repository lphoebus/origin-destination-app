...
import {
  u as u3
} from "./chunk-ONBKDM7S.js";
import {
  f as f4
} from "./chunk-PWBQGD4B.js";
import {
  W as W2
} from "./chunk-DMIYEEKR.js";
import {
  s as s4,
  t as t2
} from "./chunk-A2VTMNJ3.js";
import {
  ut
} from "./chunk-PNFUWJ4W.js";
import {
  s as s2
} from "./chunk-LPC5EXUG.js";
import {
  L
  ...
  writeToStore(o9, n12, p13) {
    ...
    return o9.forEach((o10) => {
      ...
      if (p13 && o10.properties[p13] && (c6 = ut(o10.properties[p13])), "originId" in o10 && "destinationId" in o10 && (o10.properties[I] = o10.originId, o10.properties[t4] = o10.destinationId), o10.properties[n12] = o10.id, o10.id && this._featureLookup.has(o10.id) && this._featureLookup.get(o10.id).attributes) {
        ...
        p13 && o10.properties[p13] && (i10[p13] = f2(o10.properties[p13])), u9 = new s2(c6 ? JSON.parse(JSON.stringify(c6)) : (t7 == null ? void 0 : t7.geometry) ? JSON.parse(JSON.stringify(t7.geometry)) : null, i10, null, o10.properties[n12]);
...
var n9 = null;
function r4() {
  return e5 || (e5 = import("./lclayout-LKZX4BVP.js").then((t7) => t7.l).then(({ default: e7 }) => e7({ locateFile: (e8) => n(`esri/libs/linkchartlayout/${e8}`) })).then((t7) => {
    s6(t7);
  }), e5);
}
function s6(t7) {
...
async function g4(o9, e7, t7) {
  ...
  const a9 = s8.join(" UNION "), l12 = new p7({ openCypherQuery: a9, bindParameters: i10 }), m7 = (await ie(e7, l12, t7 == null ? void 0 : t7.requestOptions)).resultRowsStream.getReader();
  for (; ; ) {
...
var N3 = class extends b {
  ...
  async getConnectedRecordIds(e7, t7, i10) {
    ...
    const p13 = r7.join(" UNION "), d7 = (await ie(this.knowledgeGraph, new p7({ openCypherQuery: p13, bindParameters: a9 }), { signal: i10 == null ? void 0 : i10.signal })).resultRowsStream.getReader();
    for (; ; ) {
  ...
  async getRelationshipsBetweenNodes(e7, t7, i10) {
    ...
    const a9 = s8.join(" UNION "), r7 = [], p13 = (await ie(this.knowledgeGraph, new p7({ openCypherQuery: a9, bindParameters: o9 }), { signal: i10 == null ? void 0 : i10.signal })).resultRowsStream.getReader();
    for (; ; ) {
  ...
  async getRelationshipsFromNodes(e7, t7, i10, n12) {
    ...
    const r7 = a9.join(" UNION "), p13 = /* @__PURE__ */ new Map(), d7 = (await ie(this.knowledgeGraph, new p7({ openCypherQuery: r7, bindParameters: s8 }), { signal: n12 == null ? void 0 : n12.signal })).resultRowsStream.getReader();
    for (; ; ) {
      const { done: e8, value: t8 } = await d7.read();
      if (e8) break;
      for (let i11 = 0; i11 < t8.length; i11++) {
...
//# sourceMappingURL=chunk-WI2LIAWZ.js.map
