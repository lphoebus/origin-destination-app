...
return color;
}`)}const Ue=k();function _t(a,e){const{hasModelTransformation:t,instancedDoublePrecision:o,instanced:r,output:s,hasVertexTangents:d}=e;t&&(a.vertex.uniforms.add(new ha("model",l=>l.modelTransformation??De)),a.vertex.uniforms.add(new I("normalLocalOriginFromModel",l=>(Xt(Ue,l.modelTransformation??De),Ue)))),r&&o&&(a.attributes.add("instanceModelOriginHi","vec3"),a.attributes.add("instanceModelOriginLo","vec3"),a.attributes.add("instanceModel","mat3"),a.attributes.add("instanceModelNormal","mat3"));const n=a.vertex;o&&(n.include(Ja,e),n.uniforms.add(new W("viewOriginHi",l=>ma(P(ie,l.camera.viewInverseTransposeMatrix[3],l.camera.viewInverseTransposeMatrix[7],l.camera.viewInverseTransposeMatrix[11]),ie)),new W("viewOriginLo",l=>pa(P(ie,l.camera.viewInverseTransposeMatrix[3],l.camera.viewInverseTransposeMatrix[7],l.camera.viewInverseTransposeMatrix[11]),ie)))),n.code.add(i`
...
float evaluateAmbientOcclusion() { return 0.0; }`)}function Co(a,e){const t=a.fragment,o=e.lightingSphericalHarmonicsOrder!==void 0?e.lightingSphericalHarmonicsOrder:2;o===0?(t.uniforms.add(new W("lightingAmbientSH0",({lighting:r})=>P(Ke,r.sh.r[0],r.sh.g[0],r.sh.b[0]))),t.code.add(i`vec3 calculateAmbientIrradiance(vec3 normal, float ambientOcclusion) {
...
return mix(mrr, vec3(0.0, 1.0, 0.04), snow);
  ...
  `),e.include(Ft,a),r.include(Ee,a),e.include(B,a),r.include(G,a),e.include(xt,a),le(r,a),r.uniforms.add(o.uniforms.get("localOrigin"),new ee("ambient",b=>b.ambient),new ee("diffuse",b=>b.diffuse),new N("opacity",b=>b.opacity),new N("layerOpacity",b=>b.layerOpacity)),O&&r.uniforms.add(new y("tex",b=>b.texture)),e.include(Ot,a),r.include(Re,a),r.include(Vt),e.include(No,a),r.include(Et,a),Ae(r),je(r),te(r),r.main.add(i`
    discardBySlice(vpos);
  ...
  `);const{hasColorTexture:M,hasColorTextureTransform:C}=a;return e.include(Ft,a),r.include(Ee,a),e.include(B,a),r.include(G,a),e.include(xt,a),le(r,a),ue(r),Ae(r),je(r),r.uniforms.add(o.uniforms.get("localOrigin"),o.uniforms.get("view"),new ee("ambient",g=>g.ambient),new ee("diffuse",g=>g.diffuse),new N("opacity",g=>g.opacity),new N("layerOpacity",g=>g.layerOpacity)),M&&r.uniforms.add(new y("tex",g=>g.texture)),e.include(Ot,a),r.include(Re,a),r.include(Vt),r.include(Et,a),te(r),r.main.add(i`
      discardBySlice(vpos);
      discardByTerrainDepth();
