import{kJ as A,dv as M,fu as at,l9 as Ne,kM as le,oS as ee,u_ as rt,s$ as ce,u$ as st,kL as lt,kN as ct,kQ as ft,kP as ut,kI as H,r6 as dt,ha as _t,ju as vt,pa as ht,v0 as mt,bF as k,d6 as ge,v1 as pt,fz as oe,nJ as Fe,bf as ve,v2 as gt,v3 as yt,v4 as xt,v5 as St,fP as Tt,fR as It,dC as bt,v6 as N,v7 as Be,v8 as ye,v9 as Et,kO as Ot,va as xe,cY as Se,b4 as Ue,l6 as At,iv as Te,bE as Pt,vb as Mt}from"./index-Bkom2Sdc.js";import{$ as Ct,d as Ie,f as Lt,g as Ye,s as z,t as zt,n as q,e as X,h as Ge}from"./Utils-BPwjYj-m.js";import{e as Dt,a as te}from"./ProgramTemplate-D6UgULFC.js";import{h as $}from"./VertexArrayObject-BCHRBpsS.js";import{n as Rt}from"./VertexAttributeLocations-BfZbt_DV.js";import{t as ne}from"./VertexElementDescriptor-BLyltQyJ.js";import{r as j}from"./VertexBuffer-CsbdF0n4.js";import{n as Vt}from"./vec3f32-WCVSSNPR.js";import{e as ke,n as wt}from"./Container-BUOpKgJS.js";import{o as fe}from"./BufferObject-CTARDp2h.js";import{e as be}from"./config-BOD8--da.js";import{e as Nt}from"./earcut-D9gy186-.js";import{t as Ft,X as Bt}from"./featureConversionUtils-nye7QKUe.js";function He(){return new Float32Array(4)}function Ut(f){const e=new Float32Array(4);return e[0]=f[0],e[1]=f[1],e[2]=f[2],e[3]=f[3],e}function B(f,e,t,n){const i=new Float32Array(4);return i[0]=f,i[1]=e,i[2]=t,i[3]=n,i}function $e(){return He()}function We(){return B(1,1,1,1)}function Ze(){return B(1,0,0,0)}function je(){return B(0,1,0,0)}function Ke(){return B(0,0,1,0)}function Xe(){return B(0,0,0,1)}const Yt=$e(),Gt=We(),kt=Ze(),Ht=je(),$t=Ke(),Wt=Xe();Object.freeze(Object.defineProperty({__proto__:null,ONES:Gt,UNIT_W:Wt,UNIT_X:kt,UNIT_Y:Ht,UNIT_Z:$t,ZEROS:Yt,clone:Ut,create:He,fromValues:B,ones:We,unitW:Xe,unitX:Ze,unitY:je,unitZ:Ke,zeros:$e},Symbol.toStringTag,{value:"Module"}));let U=class{constructor(){this.name=this.constructor.name||"UnnamedBrush",this.brushEffect=null}prepareState(e,t){}draw(e,t,n){}drawMany(e,t,n){for(const i of t)i.visible&&this.draw(e,i,n)}};const Zt={background:{"background.frag":`uniform lowp vec4 u_color;
void main() {
