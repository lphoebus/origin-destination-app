...
return isClamped ? floor(antiAliasedResult + 0.5) : antiAliasedResult;
  ...
  `)}function Rt(a){const e=a.stipplePattern;return e?_a(a.stipplePattern)/e.pixelRatio:1}const Pa=.4,Et=64,za=Et/2,wa=za/5,Oa=Et/wa,zs=.25;function Ca(a,e){const t=a.vertex,i=e.hasScreenSizePerspective;et(t),t.uniforms.get("markerScale")==null&&t.constants.add("markerScale","float",1),t.constants.add("markerSizePerLineWidth","float",Oa).code.add(c`
...
vec2(vStippleDistanceLimits.x, 1e34);`)),s.main.add(c`
    ...
    }`),e.fragment.include(wi,a),e.include(Oi,a),n.include(Ci),n.main.add(c`discardBySlice(vpos);
