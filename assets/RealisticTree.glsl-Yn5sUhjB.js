import{jP as $e,dx as x,e3 as k,dB as Fe,lg as et,g1 as Bt,gA as Ht,jI as Wt,ha as V,jy as kt,r6 as Ut,l2 as Yt,yQ as tt,b8 as c,ba as H,bb as at,yR as Zt,yS as qt,lo as Q,dh as ot,ln as Oe,jG as De,jw as Xt,ns as Jt,yT as U,aH as he,iv as rt,l1 as ne,cK as re,fI as Kt,fK as Qt,c$ as ea,bI as ta,kD as aa,fb as oa,dR as z,gG as ra,jW as ia,e5 as na,dz as sa,dW as la,gb as we,gc as ca,gj as Ge,dS as da,ju as ua}from"./index-CijYe-e2.js";import{ab as P,i as me,d as pe,aX as I,a as it,aY as fe,aZ as nt,a_ as st,a$ as ha,b0 as W,b1 as ma,b2 as pa,ad as fa,f as va,b3 as J,r as N,a2 as ae,D as A,E as j,b4 as D,G as K,b as y,I as G,al as ga,H as xa,b5 as ba,b6 as lt,q as se,aj as ct,o as dt,aU as ut,g as wa,j as Ne,k as ve,s as ht,b7 as ya,aH as Ma,u as Ta,v as Be,ah as _a,aa as _,aF as Ie,ag as Sa,b8 as Ca,c as ee,b9 as za,X as oe,ba as $a,M as Fa,bb as mt,a9 as le,F as pt,L as ft,K as vt,bc as gt,J as xt,N as Oa,T as Na,O as Ia,P as La,Q as Va,R as Pa,U as Ra,V as Ea,W as Aa,Y as ja,x as m,A as Da,bd as ye,be as Me,a1 as Ga,aq as Ba,B as Ha,aS as Wa,a3 as ka,az as Ua}from"./OutputColorHighlightOID.glsl-__BEMhzt.js";import{t as ze,Q as Le}from"./InterleavedLayout-CEIJvB-H.js";import{s as S,T as bt,g as ce,I as He}from"./BufferView-3iAamkkw.js";import{r as Ya}from"./VertexBuffer-DN_7zCfs.js";import{g as Za}from"./plane-CA0BvbU2.js";import{T as Ve,d as Pe,_ as qa}from"./renderState-CKc66y4x.js";import{t as Xa}from"./VertexAttributeLocations-BfZbt_DV.js";import{t as i,n as p}from"./glsl-B5bJgrnA.js";import{s as ge}from"./ShaderBuilder-KJWC6NgP.js";function xe(a,e){switch(a.fragment.code.add(i`vec3 screenDerivativeNormal(vec3 positionView) {
...
return color;
}`)}const Ue=k();function _t(a,e){const{hasModelTransformation:t,instancedDoublePrecision:o,instanced:r,output:s,hasVertexTangents:d}=e;t&&(a.vertex.uniforms.add(new ha("model",l=>l.modelTransformation??De)),a.vertex.uniforms.add(new I("normalLocalOriginFromModel",l=>(Xt(Ue,l.modelTransformation??De),Ue)))),r&&o&&(a.attributes.add("instanceModelOriginHi","vec3"),a.attributes.add("instanceModelOriginLo","vec3"),a.attributes.add("instanceModel","mat3"),a.attributes.add("instanceModelNormal","mat3"));const n=a.vertex;o&&(n.include(Ja,e),n.uniforms.add(new W("viewOriginHi",l=>ma(V(ie,l.camera.viewInverseTransposeMatrix[3],l.camera.viewInverseTransposeMatrix[7],l.camera.viewInverseTransposeMatrix[11]),ie)),new W("viewOriginLo",l=>pa(V(ie,l.camera.viewInverseTransposeMatrix[3],l.camera.viewInverseTransposeMatrix[7],l.camera.viewInverseTransposeMatrix[11]),ie)))),n.code.add(i`
...
}`)}}function B(a,e){fo(a,e,new N("textureAlphaCutoff",t=>t.textureAlphaCutoff))}function fo(a,e,t){const o=a.fragment,r=e.alphaDiscardMode,s=r===0;r!==2&&r!==3||o.uniforms.add(t),o.code.add(i`
...
forwardTextureCoordinates();`),a.include(B,e),o.main.add(i`
        ...
        ${p(n,i`vec4 texColor = texture(tex, ${f?"colorUV":"vuv0"});
                discardOrAdjustAlpha(texColor);`)}`);break;case 4:case 5:case 6:case 7:case 10:A(t,e),a.include(j),a.include(D,e),a.include(K,e),a.include(po,e),o.include(G,e),a.include(xa,e),ba(a),r.add("depth","float",{invariant:!0}),n&&o.uniforms.add(new y("tex",v=>v.texture)),t.main.add(i`vpos = getVertexInLocalOriginSpace();
vpos = subtractOrigin(vpos);
vpos = addVerticalOffset(vpos, localOrigin);
...
vpos = addVerticalOffset(vpos, localOrigin);
gl_Position = transformPosition(proj, view, vpos);
forwardTextureCoordinates();`),o.include(G,e),a.include(B,e),a.include(ga,e),o.main.add(i`
        discardBySlice(vpos);
        ${p(n,i`vec4 texColor = texture(tex, ${f?"colorUV":"vuv0"});
                discardOrAdjustAlpha(texColor);`)}
...
}`))}const go=3e5,Ye=5e5,_e=4;function zt(){const a=new ge,e=a.fragment;a.include(dt);const t=(_e+1)/2,o=1/(2*t*t);return e.include(ut),e.uniforms.add(new y("depthMap",r=>r.depthTexture),new se("tex",r=>r.colorTexture),new wa("blurSize",r=>r.blurSize),new N("projScale",(r,s)=>{const d=s.camera.distance;return d>5e4?Math.max(0,r.projScale-(d-5e4)):r.projScale})),e.code.add(i`
...
}`)}function Ee(a,e){a.include(Ie),e.pbrMode!==1&&e.pbrMode!==2&&e.pbrMode!==5&&e.pbrMode!==6||(a.code.add(i`float normalDistribution(float NdotH, float roughness)
{
...
}`),o){case 0:case 4:case 3:a.include(zo),t.code.add(i`vec3 evaluateSceneLighting(vec3 normalWorld, vec3 albedo, float shadow, float ssao, vec3 additionalLight) {
...
}`);break;default:$e(e.doubleSidedMode);case 3:}}function Ot(a,e){const t=e.pbrMode,o=a.fragment;if(t!==2&&t!==0&&t!==1)return void o.code.add(i`void applyPBRFactors() {}`);if(t===0)return void o.code.add(i`void applyPBRFactors() {}
...
float occlusion;`),r&&o.uniforms.add(l===1?new y("texMetallicRoughness",u=>u.textureMetallicRoughness):new se("texMetallicRoughness",u=>u.textureMetallicRoughness)),d&&o.uniforms.add(l===1?new y("texOcclusion",u=>u.textureOcclusion):new se("texOcclusion",u=>u.textureOcclusion)),o.uniforms.add(l===1?new ee("mrrFactors",u=>u.mrrFactors):new za("mrrFactors",u=>u.mrrFactors)),o.code.add(i`
  ...
  `)}let Lo=class extends me{constructor(e,t,o,r){super(e,"mat4",2,(s,d,n,l)=>s.setUniformMatrices4fv(e,t(d,n,l),r),o)}},Vo=class extends me{constructor(e,t,o,r){super(e,"mat4",1,(s,d,n)=>s.setUniformMatrices4fv(e,t(d,n),r),o)}};function Po(a){a.fragment.uniforms.add(new Vo("shadowMapMatrix",(e,t)=>t.shadowMap.getShadowMapMatrices(e.origin),4)),Nt(a)}function Ro(a){a.fragment.uniforms.add(new Lo("shadowMapMatrix",(e,t)=>t.shadowMap.getShadowMapMatrices(e.origin),4)),Nt(a)}function Nt(a){const{fragment:e}=a;e.uniforms.add(new _("cascadeDistances",t=>t.shadowMap.cascadeDistances),new $a("numCascades",t=>t.shadowMap.numCascades)),e.code.add(i`const vec3 invalidShadowmapUVZ = vec3(0.0, 0.0, -1.0);
...
return texture(_shadowMap, uvzShadow);
}`)}let Ao=class extends me{constructor(e,t){super(e,"sampler2DShadow",0,(o,r)=>o.bindTexture(e,t(r)))}};function It(a,e){e.receiveShadows&&a.include(Po),Vt(a,e)}function Lt(a,e){e.receiveShadows&&a.include(Ro),Vt(a,e)}function Vt(a,e){a.fragment.uniforms.add(new P("lightingGlobalFactor",r=>r.lighting.globalFactor));const{receiveShadows:t,spherical:o}=e;a.include(Io,e),t&&jo(a),a.fragment.code.add(i`
  ...
  `)}function jo(a){a.include(Eo),a.fragment.uniforms.add(new Ao("shadowMap",({shadowMap:e})=>e.depthTexture)).code.add(i`float readShadowMap(const in vec3 _worldPos, float _linearDepth) {
...
metallicRoughnessUV = (metallicRoughnessTextureTransformMatrix * vec3(vuv0, 1.0)).xy;
  ...
  `)}function Rt(a,e){e.snowCover&&(a.uniforms.add(new P("snowCover",t=>t.snowCover)).code.add(i`float getSnow(vec3 normal, vec3 groundNormal) {
...
return mix(mrr, vec3(0.0, 1.0, 0.04), snow);
}`))}function Et(a){const e=new ge,{attributes:t,vertex:o,fragment:r,varyings:s}=e,{output:d,normalType:n,offsetBackfaces:l,spherical:u,snowCover:f,pbrMode:v,textureAlphaPremultiplied:M,instancedDoublePrecision:C,hasVertexColors:g,hasVertexTangents:F,hasColorTexture:O,hasNormalTexture:Y,hasNormalTextureTransform:R,hasColorTextureTransform:E}=a;if(A(o,a),t.add("position","vec3"),s.add("vpos","vec3",{invariant:!0}),e.include(K,a),e.include(_t,a),e.include(mt,a),e.include(Do,a),!oe(d))return e.include(Ct,a),e;e.include(Go,a),e.include(Bo,a),e.include(Ho,a),e.include(Wo,a),le(o,a),e.include(xe,a),e.include(j);const L=n===0||n===1;return L&&l&&e.include(Mt),e.include(vo,a),e.include(wt,a),e.include(Tt,a),s.add("vPositionLocal","vec3"),e.include(D,a),e.include(St,a),e.include(pt,a),o.uniforms.add(new ft("externalColor",b=>b.externalColor,{supportsNaN:!0})),s.add("vcolorExt","vec4"),e.include(vt,a),o.include(fe),o.include(gt),e.include(C?It:Lt,a),o.main.add(i`
  ...
  `),e.include(Ft,a),r.include(Re,a),e.include(B,a),r.include(G,a),e.include(xt,a),le(r,a),r.uniforms.add(o.uniforms.get("localOrigin"),new ee("ambient",b=>b.ambient),new ee("diffuse",b=>b.diffuse),new N("opacity",b=>b.opacity),new N("layerOpacity",b=>b.layerOpacity)),O&&r.uniforms.add(new y("tex",b=>b.texture)),e.include(Ot,a),r.include(Ee,a),r.include(Pt),e.include(No,a),r.include(Rt,a),Ae(r),je(r),te(r),r.main.add(i`
    discardBySlice(vpos);
  ...
  `);const{hasColorTexture:M,hasColorTextureTransform:C}=a;return e.include(Ft,a),r.include(Re,a),e.include(B,a),r.include(G,a),e.include(xt,a),le(r,a),ue(r),Ae(r),je(r),r.uniforms.add(o.uniforms.get("localOrigin"),o.uniforms.get("view"),new ee("ambient",g=>g.ambient),new ee("diffuse",g=>g.diffuse),new N("opacity",g=>g.opacity),new N("layerOpacity",g=>g.layerOpacity)),M&&r.uniforms.add(new y("tex",g=>g.texture)),e.include(Ot,a),r.include(Ee,a),r.include(Pt),r.include(Rt,a),te(r),r.main.add(i`
      discardBySlice(vpos);
      discardByTerrainDepth();
